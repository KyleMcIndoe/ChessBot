...
exports.PHMap.set("c2b", new posVals(0.6, 1, 1, 1, 1, 1));
exports.PHMap.set("d2b", new posVals(0.6, 1, 1, 1, 1, 1));
exports.PHMap.set("e2b", new posVals(0.6, 1, 1, 1, 1, 1));
exports.PHMap.set("f2b", new posVals(0.6, 1, 1, 1, 1, 1));
...
exports.PHMap.set("b4b", new posVals(0.4, 1, 1, 1, 1, 1));
...
exports.PHMap.set("g4b", new posVals(0.4, 1, 1, 1, 1, 1));
